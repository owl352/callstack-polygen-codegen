...
import { HEADER, STRUCT_TYPE_PREFIX, TABLE_KIND_TO_CLASS_NAME, fromJSINumber, toJSINumber, } from '../common.js';
export function buildExportBridgeHeader(module) {
...
function wrapNativeReturnIntoJSI(varName, types) {
    if (types.length > 1) {
...
export function buildExportBridgeSource(module) {
    function makeExportFunc(func) {
    ...
    function makeExportTable(table) {

 ...
 */
export const TABLE_KIND_TO_NATIVE_C_TYPE = {
 ...
 */
export const TABLE_KIND_TO_CLASS_NAME = {
 ...
 */
export const STRUCT_TYPE_PREFIX = {
    i32: 'i',
    i64: 'j',
    f32: 'f',
    f64: 'd',
...
export function toJSINumber(expr) {
    return `jsi::Value { (double)(${expr}) }`;
}
export function fromJSINumber(expr, type) {

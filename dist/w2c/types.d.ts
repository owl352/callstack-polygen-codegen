import type { ModuleExport, ModuleFunction, ModuleImport, ModuleSymbol } from '@callstack/wasm-parser';
...
export type GeneratedFunctionImport = GeneratedImport<ModuleFunction> & GeneratedFunctionInfo;
export interface GeneratedExport<T = ModuleSymbol> extends ModuleExport<T> {
    mangledName: string;
    generatedFunctionName: string;
}
export type GeneratedFunctionExport = GeneratedExport<ModuleFunction> & GeneratedFunctionInfo;
